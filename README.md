# DATOS PARA EL ANÁLISIS DE LA ENCUESTA NACIONAL DE SEGURIDAD PÚBLICA URBANA (ENSU) DEL INEGI EN R
...
- Fuente: INEGI. Encuesta Nacional de Seguridad Pública Urbana (ENSU), primer trimestre de 2019 a primer trimestre de 2026.
...
other attached packages:
 [1] rsvg_2.7.0         DiagrammeRsvg_0.1  DiagrammeR_1.0.11  quarto_1.5.1      
 [5] RColorBrewer_1.1-3 rstatix_0.7.2      car_3.1-3          carData_3.0-5     
 [9] purrr_1.1.0        DT_0.33            kableExtra_1.4.0   rmarkdown_2.30    
[13] tibble_3.3.0       htmlwidgets_1.6.4  stringr_1.5.1      crosstalk_1.2.2   
[17] plotly_4.11.0      ggplot2_4.0.1      tidyr_1.3.1        rlang_1.1.6       
[21] descr_1.1.8        srvyr_1.3.0        survey_4.4-2       survival_3.8-3    
[25] Matrix_1.7-3       dplyr_1.1.4        data.table_1.18.0  lessR_4.4.5       
[29] colorspace_2.1-1  

loaded via a namespace (and not attached):
 [1] tidyselect_1.2.1    viridisLite_0.4.2   farver_2.1.2        S7_0.2.0           
 [5] fastmap_1.2.0       lazyeval_0.2.2      digest_0.6.37       lifecycle_1.0.4    
 [9] processx_3.8.6      magrittr_2.0.3      compiler_4.5.1      yaml_2.3.10        
[13] knitr_1.50          curl_6.4.0          interp_1.1-6        xml2_1.3.8         
[17] abind_1.4-8         withr_3.0.2         latticeExtra_0.6-30 xtable_1.8-4       
[21] scales_1.4.0        MASS_7.3-65         cli_3.6.5           ellipse_0.5.0      
[25] generics_0.1.4      rstudioapi_0.17.1   robustbase_0.99-6   httr_1.4.7         
[29] visNetwork_2.1.4    DBI_1.2.3           splines_4.5.1       mitools_2.4        
[33] vctrs_0.6.5         V8_6.0.5            jsonlite_2.0.0      Formula_1.2-5      
[37] systemfonts_1.2.3   jpeg_0.1-11         glue_1.8.0          DEoptimR_1.1-4     
[41] ps_1.9.1            stringi_1.8.7       gtable_0.3.6        later_1.4.2        
[45] deldir_2.0-4        pillar_1.11.0       htmltools_0.5.8.1   R6_2.6.1           
[49] textshaping_1.0.1   evaluate_1.0.5      lattice_0.22-7      png_0.1-8          
[53] backports_1.5.0     leaps_3.2           openxlsx_4.2.8      broom_1.0.9        
[57] Rcpp_1.1.0          zip_2.3.3           svglite_2.2.1       xfun_0.52          
[61] pkgconfig_2.0.3 
```
